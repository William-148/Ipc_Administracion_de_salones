<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/instructor/masterInstructor.Master" AutoEventWireup="true" CodeBehind="insumos-devueltos.aspx.cs" Inherits="PlataformaWeb.paginas.instructor.insumos.insumos_devueltos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="subNavegacion">
        <a href="/paginas/instructor/insumos/insumos-prestados.aspx"><span class="icon-list"></span> Insumos Prestados</a>
    </div>
