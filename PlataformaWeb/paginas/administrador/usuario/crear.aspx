<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/masterAdmin.Master" AutoEventWireup="true" CodeBehind="crear.aspx.cs" Inherits="PlataformaWeb.paginas.usuario.crear" %>
    ...
    <form method="post" runat="server" style="width:800px;">
        ...
        <div class="caja">
            ...
            <asp:DropDownList ID="rol" runat="server" CssClass="cajaLista" >
                ...
                <asp:ListItem Value="2">Operador de Sistema</asp:ListItem>
