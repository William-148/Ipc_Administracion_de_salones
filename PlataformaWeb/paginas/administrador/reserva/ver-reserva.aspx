<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/masterAdmin.Master" AutoEventWireup="true" CodeBehind="ver-reserva.aspx.cs" Inherits="PlataformaWeb.paginas.administrador.Reserva.ver_reserva" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Ver Reserva</title>
    <script>
        function seleccionar() {
            var opcion = document.getElementsByClassName("opcion")[5];
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="subNavegacion">
        <a href="/paginas/administrador/reserva/lista-reservas.aspx"><span class="icon-list"></span> Lista de Reservaciones</a>
        <a href="/paginas/administrador/reserva/crear.aspx"><span class="icon-circle-with-plus"></span> Crear Reservación</a>
    </div>
