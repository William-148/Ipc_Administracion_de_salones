<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/operador/operador.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="PlataformaWeb.paginas.operador.home" %>
...
WHERE R.idEstadoReserva = E.idEstadoReserva and R.idInstructor = u.idUsuario and R.idSalon = S.idSalon and S.idEdificio = Ed.idEdificio and R.Fecha = CONVERT (char(10), getdate(), 103)
ORDER BY HoraInicio ASC"></asp:SqlDataSource>
