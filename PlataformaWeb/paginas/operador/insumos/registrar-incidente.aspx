<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/operador/operador.Master" AutoEventWireup="true" CodeBehind="registrar-incidente.aspx.cs" Inherits="PlataformaWeb.paginas.operador.insumos.editar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form method="post" runat="server" style="width:800px;">
        ...
        <div class="caja">            
            <a>Insumo*: </a>
            <asp:DropDownList ID="insumo" CssClass="cajaLista" runat="server" DataSourceID="insumodatos" DataTextField="Nombre" DataValueField="idInsumo" Height="70%"></asp:DropDownList>
