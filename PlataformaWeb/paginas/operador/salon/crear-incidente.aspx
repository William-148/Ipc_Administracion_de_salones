<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/operador/operador.Master" AutoEventWireup="true" CodeBehind="crear-incidente.aspx.cs" Inherits="PlataformaWeb.paginas.operador.salon.crear_incidente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Crear Incidente de Salón</title>
    <script>
