    ...
    public partial class home : System.Web.UI.Page
    {
        ...
        protected void Calendar1_DayRender(object sender, DayRenderEventArgs e)
        {
            ...
            {//El if hará que solo se haga la consulta una vez
                ...
                reservas = Actividad.getListaMatriculadas(e.Day.Date.Month, e.Day.Date.Year, Session["idUsuario"].ToString());
            }
            ...
            if (reservas != null && !e.Day.IsOtherMonth)
            {
                foreach (string[] item in reservas)
                {
                    ...
                    {
                        e.Cell.Controls.Add(new LiteralControl("<span class=\"eventoFinalizado  icon-bookmark\"></span> "));
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("/paginas/estudiante/actividades/detalle.aspx?cod=" + e.CommandArgument.ToString());
            }
        }
    }
}