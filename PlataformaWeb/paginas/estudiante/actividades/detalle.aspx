<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/estudiante/masterEstudiante.Master" AutoEventWireup="true" CodeBehind="detalle.aspx.cs" Inherits="PlataformaWeb.paginas.estudiante.actividades.detalle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="subNavegacion">
        <a href="/paginas/estudiante/actividades/actividades-matriculadas.aspx"><span class="icon-back"></span> Regresar</a>
    </div>
    ...
    <form method="post" runat="server" style="width:800px;">
        ...
        <div class="caja">
            ...
            <asp:Button ID="boton" runat="server" Text="Desmatricularse" class="boton" OnClick="boton_Click" Width="150px"  />
        ...
        <div class="caja"> 
            ...
            <asp:Button ID="descargar" runat="server" Text="Descargar Presentación" class="boton2" OnClick="descargar_Click" Visible="False"   />
