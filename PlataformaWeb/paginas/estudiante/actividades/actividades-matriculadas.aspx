<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/estudiante/masterEstudiante.Master" AutoEventWireup="true" CodeBehind="actividades-matriculadas.aspx.cs" Inherits="PlataformaWeb.paginas.estudiante.actividades.actividades_matriculadas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="subNavegacion">
        <a href="/paginas/estudiante/actividades/actividades-asistidas.aspx"><span class="icon-list"></span> Actividades Asistidas</a>
    </div>
    <form runat="server" class="cajaTabla">

        <p class="tituloTabla"> <span class="icon-list"></span> Actividades Matriculadas</p>
        ...
        <asp:GridView 
            ...
            AllowPaging="True" 
            AllowSorting="True"
            EmptyDataText ="No tengo cursos matriculados"
            PageSize="8"
            GridLines="None"
            CssClass="tabla"
	...
	FROM Actividad A, ReservaSalon R, Usuario U, TipoActividad T, Matriculacion M
	WHERE A.idActividad = R.idActividad AND R.idInstructor = U.idUsuario AND A.idTipoActividad = T.idTipoActividad
	AND A.Nombre IS NOT NULL AND A.ExtensionPresentacion IS NOT NULL AND A.idActividad = M.idActividad AND M.idUsuario = @idUsuario
